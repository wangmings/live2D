...
function loadlive2d(config){
    let [modelPath,canvasID,width,height,enlarge,bottom] = [
        config.modelConfig.modelPath,
        config.modelConfig.canvasID,
        config.modelConfig.width,
        config.modelConfig.height,
        config.modelConfig.enlarge,
        config.modelConfig.bottom
    ];

    
    let canvas = document.getElementById(canvasID);
    canvas.width = width * enlarge;
    canvas.height = height * enlarge;
    canvas.style.width = width + 'px';
    canvas.style.height = height + 'px';
    canvas.style.bottom = bottom + 'px';

    loadlive2dInit(canvasID,modelPath);
...
! function(t) {
    ...
    (function(t) {
        ! function() {
            ...
            at._$yr = !1,
                ...
                at.init = function() {
                    if (at._$6b) {
                        if(bugs) console.log("Live2D %s", at._$2s),
                            at._$6b = !1;
                        !0,
                        at.initProfile()
                    }
    ...
    r.prototype.loadBytes = function(t, i) {
            ...
            if(bugs) console.log('URL: ',t,'获取对象:',arrayBuff)

            requestCache[t] = arrayBuff;
            i(arrayBuff);
        ...
        r.prototype.loadTexture = function(t, i, e, r) {
            ...
            if(bugs) console.log('图片: ',e,imageData);
            e = imageData;
            n.src = e;
    ...
    o.prototype = new n.L2DBaseModel,
        ...
        o.prototype.setFadeInFadeOut = function(t, i, e, r) {
            ...
            if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)),
                ...
                console.log('音乐:',this.modelHomeDir + n)
